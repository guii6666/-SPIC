...
import { BookOpen, Menu, ChevronRight, Phone, ShieldAlert, User, HeartPulse, ShieldCheck, Briefcase, Plane, PlaneTakeoff, MoveRight, FileText, Download, ExternalLink } from 'lucide-react';
      ...
      >
        <div className="max-w-4xl mx-auto bg-white min-h-full md:min-h-[calc(100%-2rem)] shadow-sm border border-slate-100 rounded-none md:rounded-2xl p-6 md:p-12 animate-fade-in-up">
          ...
          <div className="prose prose-slate prose-lg max-w-none text-slate-600">
            ...
            <ReactMarkdown
              components={{
                h1: ({node, ...props}) => <h2 className="text-2xl font-bold text-blue-900 mt-10 mb-4 flex items-center" {...props} />,
                h2: ({node, ...props}) => <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-2 pl-3 border-l-4 border-blue-500" {...props} />,
                ul: ({node, ...props}) => <ul className="list-disc list-outside ml-5 space-y-2 my-4 text-slate-600" {...props} />,
                li: ({node, ...props}) => <li className="pl-1 leading-relaxed" {...props} />,
                strong: ({node, ...props}) => <strong className="font-bold text-blue-700 bg-blue-50 px-1 rounded" {...props} />,
